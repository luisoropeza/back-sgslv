...
public class RequestServiceImpl implements RequestService {
    ...
    public RequestResponse updateRequestById(Long id, RequestDto dto, MultipartFile multipartFile) throws Exception {
        ...
        Document document = documentRepository.findByRequest(request).orElse(new Document());
        deleteFile(document.getName());
        Map<String, Object> file = uploadFile(multipartFile);
        request = mainMapper.toRequest(request, document, dto, file);
        requestRepository.save(request);
        return mainMapper.toRequestResponse(request);
    }
